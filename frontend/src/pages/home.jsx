    ...
    <div className="home">
      ...
      <section className="home-hero">
        ...
        <div className="hero-text">
          ...
          <p>
            Where ideas, design, and creativity are{" "}
            <span className="highlight">shared</span>
          </p>
        </div>
        ...
        <div className="vinyl-player">
          ...
          <div className="vinyl-controls">
            {isPlaying ? (
              <button className="vinyl-btn pause" onClick={pauseMusic}>
                ❚❚
              </button>
            ) : (
              <button className="vinyl-btn play" onClick={playMusic}>
                ▶
              </button>
            )}
            <button className="vinyl-btn pause" onClick={resetMusic}>
              ⟲
            </button>
          </div>
        </div>
      ...
      <section className="home-categories">
        <div
          ...
          onClick={() => navigate("/categories?cat=3DPrinted")}
        >
          3D-Printed
        </div>
        <div
          className="category-card"
          onClick={() => navigate("/categories?cat=Canvas")}
        >
          Canvas
        </div>
        <div
          className="category-card"
          onClick={() => navigate("/categories?cat=Fabrics")}
        >
          Fabrics
        </div>
        <div
          className="category-card"
          onClick={() => navigate("/categories?cat=Digital Art")}
        >
          Digital Art
        </div>
        <div
          className="category-card"
          onClick={() => navigate("/categories?cat=Material Art")}
        >
          Material art
        </div>
      </section>
